...
(function($) {
    ...
    MultipleSelect.prototype = {
        ...
        optionToHtml: function(i, elm, group, groupDisabled) {
            ...
            if ($elm.is('option')) {
                ...
                var tmp = 'id' + (new Date()).getTime();

                html.push(
                    '<li' + (multiple ? ' class="multiple"' : '') + style + '>',
                            '<input class="css-checkbox" id="sel'+ tmp +'i'+i+'" type="' + type + '" name="selectItem" value="' + value + '"' +
                                (selected ? ' checked="checked"' : '') +
                                (disabled ? ' disabled="disabled"' : '') +
                                (group ? ' data-group="' + group + '"' : '') +
                                '/> ',
                        '<label for="sel'+ tmp +'i'+i+'" class="css-label lite-x-gray"' + (disabled ? ' class="disabled"' : '') + '>',
                            text,
                        '</label>',
                    '</li>'
                );
        ...
        events: function() {
            ...
            this.$selectItems.off('click').on('click', function() {
                ...
                that.options.onClick({
                    label: $(this).parent().text(),
                    value: $(this).val(),
                    id: $(this).parent().parent().parent().parent().parent().find('select').attr('id'),
    ...
    $.fn.multipleSelect.defaults = {
        ...
        allSelected: 'Tout sélectionner', // false or string
